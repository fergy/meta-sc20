DESCRIPTION = "QCOM Firmware for SC20 board (apq8909)"

LICENSE = "Proprietary"
LIC_FILES_CHKSUM = "file://LICENSE;md5="

SRC_URI = "http://releases.linaro.org/96boards/apq8909/qualcomm/firmware/linux-board-support-package-r${PV}.zip"
SRC_URI[md5sum] = ""
SRC_URI[sha256sum] = ""

DEPENDS += "mtools-native"

COMPATIBLE_MACHINE = "(sc20)"
